...
//#pragma config(Sensor, port7,  LeftColor,      sensorVexIQ_ColorGrayscale) //comment out for home robot testing.
//#pragma config(Sensor, port8,  MidColor,       sensorVexIQ_ColorGrayscale) //comment out for home robot testing.
//#pragma config(Sensor, port9,  RightColor,     sensorVexIQ_ColorGrayscale) //comment out for home robot testing.
